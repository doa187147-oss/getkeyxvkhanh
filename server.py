...
def _get_cached_admin_cfg():
    ...
    if _admin_cfg_cache["data"] is None or (now_t - _admin_cfg_cache["ts"]) > _ADMIN_CACHE_TTL:
        db = load_db()
        _admin_cfg_cache["data"] = db.get("___ADMIN_CONFIG___", {"user": "vkhanh", "pass": "1"})
...
.ann-btn-hide {
  ...
  border: 1.5px solid rgba(99,102,241,0.25); border-radius: 12px;
  padding: 10px 20px; font-size: 0.82rem; font-weight: 800;
  cursor: pointer; font-family: 'Nunito', sans-serif;
  transition: background 0.2s;
}
.ann-btn-hide:hover { background: rgba(99,102,241,0.15); }
.ann-btn-close {
...
.ann-admin-card {
  ...
  border: 1.5px solid rgba(99,102,241,0.18); border-radius: 16px;
...
.vinyl-c { width: 20px; height: 20px; background: var(--grad); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 0 8px rgba(99,102,241,0.6); z-index:1; }
.vinyl.spin { animation: vinylSpin 2.2s linear infinite; }
@keyframes vinylSpin { to { transform: rotate(360deg); } }
.vinyl.spin { box-shadow: 0 4px 18px rgba(0,0,0,0.35), 0 0 22px rgba(99,102,241,0.4), inset 0 2px 4px rgba(255,255,255,0.06); }
...
<div class="tab active" id="tab-trangchu">
  ...
  <div style="text-align:center;padding:22px 0 10px;">
    ...
    <div style="font-family:'Orbitron',sans-serif;font-size:1.55rem;font-weight:900;background:var(--grad);-webkit-background-clip:text;-webkit-text-fill-color:transparent;letter-spacing:3px;margin-bottom:4px;text-shadow:0 2px 18px rgba(99,102,241,0.35);">VĂN KHÁNH</div>
    <div style="font-family:'Orbitron',sans-serif;font-size:0.85rem;font-weight:800;color:var(--text2);letter-spacing:4px;margin-bottom:4px;">SERVER</div>
    <div style="font-size:0.78rem;color:var(--text2);font-weight:600;"> Trang Sever Key VKhanh </div>
  </div>
  ...
  <div class="getkey-card" id="getkey-section">
    ...
    <div class="getkey-sub"> Làm Nhiệm Vụ Nhận Key Miễn Phí </div>
  ...
  <div class="card">
    ...
    <a class="social-btn social-tg" href="https://t.me/hengaplai2026" target="_blank">
    ...
    <a class="social-btn social-fb" href="https://www.facebook.com/sharer/sharer.php?u=https://vkhanh.onrender.com" target="_blank">
      ...
      <div class="s-text"><span class="s-label">Facebook</span><span class="s-name"> Facebook </span></div>
      <span class="s-arrow"><i class="fa-solid fa-chevron-right"></i></span>
    </a>
  </div>
...
function renderDbTable(){
  ...
  rows.forEach(function(k,i){
    ...
    html+='<tr style="'+(locked?'opacity:0.65;':'')+'\">'
      ...
      +'<button class="btn-sm" title="Sao chép tạo key mới" onclick="cloneKey(_dbKeyArr['+i+'])" style="padding:4px 7px;background:rgba(99,102,241,0.1);color:var(--primary);border:1px solid rgba(99,102,241,0.25);border-radius:8px;"><i class="fa-solid fa-clone"></i></button>'
